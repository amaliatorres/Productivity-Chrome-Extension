// document method querySelector() returns the first element 
// within the document that matches the specified selector
var addTodoBtn = document.querySelector("#add-todo"); // BLUE ADD BUTTON
var todoField = document.querySelector("#todo-field"); //INPUT FIELD
var todoList = document.querySelector("#todo-list"); //
var clearTodosBtn = document.querySelector("#clear-todos");//CLEAR

//Events are signals fired inside the browser window that notify of 
//changes in the browser or operating system environment.
...
function refreshTodos() {
  ...
  chrome.storage.local.get("todos", (data) => { // chrome.storage.local.get to store user data
